...
echo "<div class=\"tableau\">";
  ...
  $requete6="SELECT SUM(score) FROM testPartiel WHERE idUtilisateur IN (SELECT idUtilisateur FROM utilisateur WHERE nom='Ludivine')";
  $requete7="SELECT SUM(score) FROM testComplet WHERE idUtilisateur IN (SELECT idUtilisateur FROM utilisateur WHERE nom='Ludivine')";
  ...
  $somme_score_tests_partiels = mysqli_fetch_row($resultat6);
  $somme_score_tests_complets = mysqli_fetch_row($resultat7);
  ...
  $moyenne_score = ($somme_score_tests_partiels[0]+$somme_score_tests_complets[0])/$tests_pilote;
