  ...
  <body>
    ...
    <div id="recherche" class="onglets">
      <form method="POST" style="margin:auto" action="index.php?page=gestionnaire&traitement=recherche">
        <button class="onglet" type="submit" name="recherchenom" id="validerFiltre" style="<?php if (isset($_POST["recherchenom"])) echo "background: #82A0B5" ?>">
          <?php echo _RECHERCHERPILOTE ?>
        </button>
      </form>
      <form method="POST" style="margin:auto" action="index.php?page=gestionnaire&traitement=sexe">
        <button class="onglet" type="submit" name="statprofil" id="validerFiltre" style="<?php if (isset($_POST["statprofil"])) echo "background: #82A0B5" ?>">
      ...
      <form method="POST" style="margin:auto" action="index.php?page=gestionnaire&traitement=test">
        <button class="onglet" type="submit" name="stattest" id="validerFiltre" style="<?php if (isset($_POST["stattest"])) echo "background: #82A0B5" ?>">
        ...
        <form method="GET" action="index.php?page=gestionnaire&traitement=recherche" style="margin:auto;">
          <div style="display:flex;margin-top:20px">
            <div style="float:left;margin-left:5px;margin-right:5px">
              <input style="font-size:16px" type="text" name="search" placeholder="<?php echo _RECHERCHERUSER ?>" <?php if (isset($_GET["search"])) echo "value='" . $_GET["search"] . "'" ?>)>
            </div>
      ...
      <div id="chart" style="margin-bottom: 100px">
        ...
        if (isset($_POST["test"])) {
          ...
          ?>
            <ul id="bars">
              <li>
                <div data-percentage="<?php echo $pcFrequence1 ?>" class="bar"></div><span>
                  < 40 bpm</span> </li> <li>
                    <div data-percentage="<?php echo $pcFrequence2 ?>" class="bar"></div><span>40 - 60 bpm</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcFrequence3 ?>" class="bar"></div><span>60 - 80 bpm</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcFrequence4 ?>" class="bar"></div><span>80 - 100 bpm</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcFrequence5 ?>" class="bar"></div><span>100 - 120 bpm</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcFrequence6 ?>" class="bar"></div><span>> 120 bpm</span>
              </li>
            </ul>
            <div class="titre-histo">
          ...
          ?>
            <ul id="bars">
              <li style="width:300px">
                ...
                <span>
                  < 35 dBA</span> </li> <li style="width:300px">
          ...
          ?>
            <ul id="bars">
              <li>
                <div data-percentage="<?php echo $pcStimulusVisuel1 ?>" class="bar"></div><span>
                  < 200 ms</span> </li> <li>
                    <div data-percentage="<?php echo $pcStimulusVisuel2 ?>" class="bar"></div><span>200 - 400 ms</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcStimulusVisuel3 ?>" class="bar"></div><span>400 - 600 ms</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcStimulusVisuel4 ?>" class="bar"></div><span>600 - 800 ms</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcStimulusVisuel5 ?>" class="bar"></div><span>800 - 1000 ms</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcStimulusVisuel6 ?>" class="bar"></div><span>1000 - 1200 ms</span>
              </li>
            </ul>
            <div class="titre-histo">
          ...
          ?>
            <ul id="bars">
              <li>
                <div data-percentage="<?php echo $pcTemperaturePeau1 ?>" class="bar"></div><span>
                  < 20°C</span> </li> <li>
                    <div data-percentage="<?php echo $pcTemperaturePeau2 ?>" class="bar"></div><span>20 - 25°C</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcTemperaturePeau3 ?>" class="bar"></div><span>25 - 30°C</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcTemperaturePeau4 ?>" class="bar"></div><span>30 - 35°C</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcTemperaturePeau5 ?>" class="bar"></div><span>35 - 40°C</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcTemperaturePeau6 ?>" class="bar"></div><span>> 40°C</span>
              </li>
            </ul>
            <div class="titre-histo">
          ...
          ?>
            <ul id="bars">
              <li>
                <div data-percentage="<?php echo $pcReconnaissanceTonalite1 ?>" class="bar"></div><span>
                  < 130 Hz</span> </li> <li>
                    <div data-percentage="<?php echo $pcReconnaissanceTonalite2 ?>" class="bar"></div><span>130 - 775 Hz</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcReconnaissanceTonalite3 ?>" class="bar"></div><span>775 - 1420 Hz</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcReconnaissanceTonalite4 ?>" class="bar"></div><span>1420 - 2065 Hz</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcReconnaissanceTonalite5 ?>" class="bar"></div><span>2065 - 2710 Hz</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcReconnaissanceTonalite6 ?>" class="bar"></div><span>2710 - 3355 Hz</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcReconnaissanceTonalite7 ?>" class="bar"></div><span>3355 - 4000 Hz</span>
              </li>
              <li>
                <div data-percentage="<?php echo $pcReconnaissanceTonalite8 ?>" class="bar"></div><span>> 4000 Hz</span>
              </li>
            </ul>
            <div class="titre-histo">
