...
<body>
  ...
  <div id="droite">
    <form method="POST" action="index.php">
      ...
      <input type="text" name="mail" id="mail" placeholder="<?php echo _ADDRESSEEMAIL ?>" />
      <label for="mdp"></label>
      <input type="password" name="mdp" id="mdp" placeholder="<?php echo _MOTDEPASSE ?>" />
      ...
      <div class="reseaux">
        ...
        <div id="boutonsReseau">
          <ul>
            <li><a id="facebook-button" class="btn btn-block btn-social btn-facebook">
                <i class="fa fa-facebook"></i>
                <p><?php echo _RESEAUFB ?></p>
              </a>
